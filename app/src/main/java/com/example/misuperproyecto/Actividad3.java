package com.example.misuperproyecto;
...
//alt enter - aqui lo llamamos e iniciamos la actividad main activity 2
    public void actividad2(View view) {
        startActivity(new Intent(this, MainActivity2.class));
    }
    //alt enter - aqui lo llamamos e iniciamos la actividad
    ...
    public void misuperrecicley(View view) {
